---
title: "Custom AI Menu Items (commands)"
description: "A central part when users are interacting with the AI agent is the AI Suggestion Menu where users can enter a custom prompt or select a pre-defined command:"
topics:
  - "Recursos avancados"
keywords:
...
# [Custom AI Menu Items (commands)](#custom-ai-menu-items-commands)
...
## [Defining your own commands](#defining-your-own-commands)
...
Integrate BlockNote AI with your backend](/docs/features/ai/backend-integration)[
