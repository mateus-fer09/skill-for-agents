---
title: "Backend Integration with BlockNote AI"
description: "The most common (and recommended) setup to integrate BlockNote AI with an LLM is to have BlockNote AI call your backend, which then calls an LLM of your choice using the [Vercel AI"
topics:
  - "Recursos avancados"
keywords:
...
# [Backend Integration with BlockNote AI](#backend-integration-with-blocknote-ai)
...
## [Default setup (Vercel AI SDK)](#default-setup-vercel-ai-sdk)
...
## [ClientSideTransport](#clientsidetransport)
...
### [With a proxy server](#with-a-proxy-server)
...
Add AI functionality to your BlockNote rich text editor](/docs/features/ai/getting-started)[
