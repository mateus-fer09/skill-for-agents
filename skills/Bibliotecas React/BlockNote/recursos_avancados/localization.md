...
description: "BlockNote is designed to be fully localized, with support for multiple languages. You can easily change the language of your editor or create custom translations."
topics:
  - "Recursos avancados"
keywords:
  - "Localization (i18n)"
  - "dictionary"
source_scope:
  - "https://www.blocknotejs.org/docs/features/localization"
---
...
## [Customizing Text Strings](#customizing-text-strings)
