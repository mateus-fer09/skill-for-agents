...
description: "BlockNote is compatible with a few different storage formats, each with its own advantages and disadvantages. This guide will show you how to use each of them."
topics:
...
*lossy*. While we'd ideally support every format, **other formats may not
support all BlockNote content.**

See the table below for a summary of the formats we support and their lossiness:
[](/pricing)**``****``****``****``****[](/docs/features/export/pdf)**``**[](/docs/features/export/docx)**``**[](/docs/features/export/odt)**``**[](/docs/features/export/email)**``
...
## [Working with Blocks (JSON)](#working-with-blocks-json)
...
### [Loading from HTML](#loading-from-html)
...
### [Saving as Markdown](#saving-as-markdown)
...
### [Loading from Markdown](#loading-from-markdown)
...
Learn how to manipulate blocks in the editor.](/docs/foundations/manipulating-content)[

AI Rich Text Editing

Add AI functionality to your BlockNote rich text editor](/docs/features/ai)
