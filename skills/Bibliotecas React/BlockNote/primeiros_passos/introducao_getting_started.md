...
description: "Getting started with BlockNote is quick and easy. Install the required packages and add the React component to your app."
topics:
  - "Primeiros passos"
keywords:
  - "Getting Started"
...
BlockNote is a block-based rich-text editor for React, focused on providing a great out-of-the-box experience with minimal setup.](/docs)[

With Mantine

Mantine rich text editor using BlockNote](/docs/getting-started/mantine)
