...
description: "BlockNote is a component that should only be rendered client-side (and not on the server). If you're using Next.js, you need to make sure that Next.js does not try to render BlockN"
topics:
  - "Primeiros passos"
keywords:
  ...
  - "DynamicEditor.tsx"
source_scope:
  - "https://www.blocknotejs.org/docs/getting-started/nextjs"
---
...
## [Import as dynamic](#import-as-dynamic)
...
## [Import in a page / app](#import-in-a-page--app)
...
ShadCN rich text editor using BlockNote](/docs/getting-started/shadcn)[
