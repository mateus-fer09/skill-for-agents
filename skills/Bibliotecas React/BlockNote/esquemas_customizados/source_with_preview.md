...
description: "Some blocks are authored as source code but are more useful shown as the thing that code produces — a LaTeX formula rendered as a formula, or Mermaid source rendered as a diagram. "
topics:
...
keywords:
  ...
  - "PreviewPlaceholder"
source_scope:
  - "https://www.blocknotejs.org/docs/features/custom-schemas/source-with-preview"
---

# [Source with Preview Blocks](#source-with-preview-blocks)
...
Learn how to use BlockNote With React](/docs/react/overview)
