...
keywords:
  ...
  - "main"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/electron-timelines"
---
...
[!TIP] See the [Electron Versioning](/pt/docs/latest/tutorial/electron-versioning) document for more details on how Electron is versioned.
...
[!TIP] Chromium's public release schedule is [here](https://chromiumdash.appspot.com/schedule).
...
[!TIP] For a canonical list of breaking changes, see the [Breaking Changes](/pt/docs/latest/breaking-changes) document.
