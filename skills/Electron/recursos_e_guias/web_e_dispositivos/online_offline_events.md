---
title: "Detecção de Evento Online/Offline"
...
keywords:
  ...
  - "renderer.js"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/online-offline-events"
---
...
- **Main process**: Use the [`net.isOnline()`](/pt/docs/latest/api/net#netisonline) method or the [`net.online`](/pt/docs/latest/api/net#netonline-readonly) property.
...
[!NOTE] If you need to check the connection status in the main process, you can use [`net.isOnline()`](/pt/docs/latest/api/net#netisonline) directly instead of communicating from the renderer process via [IPC](/pt/docs/latest/api/ipc-renderer).
