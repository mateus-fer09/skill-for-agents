---
title: "SpellChecker"
description: "Electron has built-in support for Chromium's spellchecker since Electron 8. On Windows and Linux this is powered by Hunspell dictionaries, and on macOS it makes use of the native s"
topics:
  - "Recursos e guias"
  - "Web e dispositivos"
keywords:
...
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/spellchecker"
---
...
All the required information to generate a context menu is provided in the [`context-menu`](/pt/docs/latest/api/web-contents#event-context-menu) event on each `webContents` instance.  A small example of how to make a context menu with this information is provided below.
...
Check out the docs for [`session.setSpellCheckerDictionaryDownloadURL`](/pt/docs/latest/api/session#sessetspellcheckerdictionarydownloadurlurl) for more information on where to get the dictionary files from and how you need to host them.[Editar esta página](https://github.com/electron/electron/edit/main/docs/tutorial/spellchecker.md)
