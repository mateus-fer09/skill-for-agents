...
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/navigation-history"
---
...
The [NavigationHistory](/pt/docs/latest/api/navigation-history) class allows you to manage and interact with the browsing history of your Electron application. This powerful feature enables you to create intuitive navigation experiences for your users.

## Accessing NavigationHistory

Navigation history is stored per [`WebContents`](/pt/docs/latest/api/web-contents) instance. To access a specific instance of the NavigationHistory class, use the WebContents class's [`contents.navigationHistory` instance property](https://www.electronjs.org/docs/latest/api/web-contents#contentsnavigationhistory-readonly).
...
[docs/fiddles/features/navigation-history (43.4.0)](https://github.com/electron/electron/tree/v43.4.0/docs/fiddles/features/navigation-history)[Open in Fiddle](https://fiddle.electronjs.org/launch?target=electron/v43.4.0/docs/fiddles/features/navigation-history)
...
```
[Editar esta página](https://github.com/electron/electron/edit/main/docs/tutorial/navigation-history.md)[AnteriorNativo Arquivo Drag & Drop](/pt/docs/latest/tutorial/native-file-drag-drop)[AvançarNotificações](/pt/docs/latest/tutorial/notifications)

- [Visão Geral](#visão-geral)
- [Accessing NavigationHistory](#accessing-navigationhistory)
- [Navigating through history](#navigating-through-history)
- [Accessing history entries](#accessing-history-entries)
- [Navigating to specific entries](#navigating-to-specific-entries)
