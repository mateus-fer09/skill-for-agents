...
description: "## Custom draggable regions"
topics:
  - "Recursos e guias"
  - "Interface e janelas"
keywords:
  ...
  - "mouseleave"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/custom-window-interactions"
---
...
events, you can call the [win.setIgnoreMouseEvents(ignore)](/pt/docs/latest/api/browser-window#winsetignoremouseeventsignore-options)
API:
main.js
...
and returns to normal outside it.[Editar esta página](https://github.com/electron/electron/edit/main/docs/tutorial/custom-window-interactions.md)
