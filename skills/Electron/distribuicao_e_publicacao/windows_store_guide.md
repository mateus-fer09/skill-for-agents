---
title: "Guia para Windows Store"
description: "Com o Windows 10, o bom e velho executável win32 ganhou uma nova irmã: A Plataforma Universal do Windows. O novo formato .appx não apenas disponibiliza várias APIs poderosas como C"
topics:
...
keywords:
  ...
  - "node_modules"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/windows-store-guide"
---
...
A Microsoft [desenvolveu uma ferramenta que compila aplicações Electron em formato `.appx`](https://github.com/electron-userland/electron-windows-store), possibilitando que desenvolvedores utilizem algumas das facilidades no novo modelo de aplicação. Este modelo explica como utilizá-lo e quais as capacidades e limitações de uma aplicação Electron AppX.
...
- SDK do Windows 10, [disponível para download aqui](https://developer.microsoft.com/en-us/windows/downloads/windows-sdk/)
...
Antes de executar o CLI pela primeira vez, você deverá configurar o "Windows Desktop App Converter". Isso deverá levar alguns minutos, mas não se preocupe - você só terá de fazer isso uma vez. Download the Desktop App Converter from [here](https://learn.microsoft.com/en-us/windows/msix/packaging-tool/tool-overview). Você receberá dois arquivos: `DesktopAppConverter.zip` e `BaseImage-14316.wim`.
...
Assim que instalação estiver bem sucedida, você pode seguir e compilar sua aplicação Electron.[Editar esta página](https://github.com/electron/electron/edit/main/docs/tutorial/windows-store-guide.md)
