...
description: "This tutorial builds on the [general introduction to Native Code and Electron](/pt/docs/latest/tutorial/native-code-and-electron) and focuses on creating a native addon for macOS u"
topics:
...
keywords:
  ...
  - "package.json"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/native-code-and-electron-swift-macos"
---

# Native Code and Electron: Swift (macOS)

This tutorial builds on the [general introduction to Native Code and Electron](/pt/docs/latest/tutorial/native-code-and-electron) and focuses on creating a native addon for macOS using Swift.
...
Just like our [general introduction to Native Code and Electron](/pt/docs/latest/tutorial/native-code-and-electron), this tutorial assumes you have Node.js and npm installed, as well as the basic tools necessary for compiling native code on macOS. Você precisará do seguinte:
...
[Editar esta página](https://github.com/electron/electron/edit/main/docs/tutorial/native-code-and-electron-swift-macos.md)[AnteriorNative Code and Electron: C++ (Windows)](/pt/docs/latest/tutorial/native-code-and-electron-cpp-win32)[AvançarNative Code and Electron: C++ (Linux)](/pt/docs/latest/tutorial/native-code-and-electron-cpp-linux)
