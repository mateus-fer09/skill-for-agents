---
title: "Instruções de Compilação (macOS)"
description: "Follow the guidelines below for building Electron itself on macOS, for the purposes of creating custom Electron binaries. For bundling and distributing your app code with the prebu"
topics:
...
keywords:
  ...
  - "certifi"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/development/build-instructions-macos"
---

# Instruções de Compilação (macOS)

Follow the guidelines below for building **Electron itself** on macOS, for the purposes of creating custom Electron binaries. For bundling and distributing your app code with the prebuilt Electron binaries, see the [application distribution](/pt/docs/latest/tutorial/application-distribution) guide.
