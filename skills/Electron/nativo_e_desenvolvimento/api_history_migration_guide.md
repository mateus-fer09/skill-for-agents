...
keywords:
  ...
  - "Point"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/development/api-history-migration-guide"
---
...
- [`breaking-changes.md`](/pt/docs/latest/breaking-changes)
...
If we search through [`breaking-changes.md`](/pt/docs/latest/breaking-changes) we can find
[a function that was deprecated in Electron `25.0`](/pt/docs/latest/breaking-changes#deprecated-browserwindowsettrafficlightpositionposition).
...
Refer to the [API History section of `style-guide.md`](/pt/docs/latest/development/style-guide#api-history)
...
```
[Editar esta página](https://github.com/electron/electron/edit/main/docs/development/api-history-migration-guide.md)[AnteriorConfiguração para servidor de símbolos no Depurador](/pt/docs/latest/development/debugging-with-symbol-server)[AvançarUsing clang-tidy on C++ Code](/pt/docs/latest/development/clang-tidy)
