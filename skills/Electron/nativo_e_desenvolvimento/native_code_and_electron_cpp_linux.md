...
description: "This tutorial builds on the [general introduction to Native Code and Electron](/pt/docs/latest/tutorial/native-code-and-electron) and focuses on creating a native addon for Linux u"
topics:
  - "Nativo e desenvolvimento"
keywords:
  - "Native Code and Electron: C++ (Linux)"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/native-code-and-electron-cpp-linux"
---

# Native Code and Electron: C++ (Linux)

This tutorial builds on the [general introduction to Native Code and Electron](/pt/docs/latest/tutorial/native-code-and-electron) and focuses on creating a native addon for Linux using C++ and GTK3. To illustrate how you can embed native Linux code in your Electron app, we'll be building a basic native GTK3 GUI that communicates with Electron's JavaScript.
...
You can re-use the package we created in our [Native Code and Electron](/pt/docs/latest/tutorial/native-code-and-electron) tutorial. This tutorial will not be repeating the steps described there. Let's first setup our basic addon folder structure:
...
For more information on GTK3 development, refer to the [GTK3 Documentation](https://docs.gtk.org/gtk3/) and the [GLib/GObject documentation](https://docs.gtk.org/gobject/). You may also find the [Node.js N-API documentation](https://nodejs.org/api/n-api.html) and [node-addon-api](https://github.com/nodejs/node-addon-api) helpful for extending your native addons.[Editar esta página](https://github.com/electron/electron/edit/main/docs/tutorial/native-code-and-electron-cpp-linux.md)[AnteriorNative Code and Electron: Swift (macOS)](/pt/docs/latest/tutorial/native-code-and-electron-swift-macos)[AvançarDistributing Apps With Electron Forge](/pt/docs/latest/tutorial/forge-overview)

- [Requisitos](#requisitos)
- [1. Creating a package](#1-creating-a-package)
- [2. Setting up the build configuration](#2-setting-up-the-build-configuration)
- [3. Defining the C++ interface](#3-defining-the-c-interface)
- [4. Implementing GTK3 GUI Code](#4-implementing-gtk3-gui-code)

  - [Basic Setup and Data Structures](#basic-setup-and-data-structures)
  - [Global state and forward declarations](#global-state-and-forward-declarations)
  - [Helper Functions](#helper-functions)
  - [Event handlers](#event-handlers)
  - [GTK application setup](#gtk-application-setup)
  - [Main GUI function and thread management](#main-gui-function-and-thread-management)
  - [Callback management](#callback-management)
  - [Putting `cpp_code.cc` together](#putting-cpp_codecc-together)

- [5. Creating the Node.js addon bridge](#5-creating-the-nodejs-addon-bridge)

  - [Create a class to wrap our C++ code](#create-a-class-to-wrap-our-c-code)
  - [Implement basic functionality - HelloWorld](#implement-basic-functionality---helloworld)
  - [Setting up the event system](#setting-up-the-event-system)
  - [Putting `cpp_addon.cc` together](#putting-cpp_addoncc-together)

- [6. Creating a JavaScript wrapper](#6-creating-a-javascript-wrapper)
- [7. Building and testing the addon](#7-building-and-testing-the-addon)
