...
description: "The virtualDisplay addon leverages macOS CoreGraphics APIs to create virtual displays, allowing you to write and run multi-monitor tests without the need for physical monitors. Due"
topics:
...
keywords:
  ...
  - "number"
source_scope:
  - "https://electronjs.org/docs/latest/development/multi-monitor-testing"
---
...
Always verify actual positions with `screen.getAllDisplays()` after creation, as macOS may adjust coordinates from the set values.[Edit this page](https://github.com/electron/electron/edit/main/docs/development/multi-monitor-testing.md)
