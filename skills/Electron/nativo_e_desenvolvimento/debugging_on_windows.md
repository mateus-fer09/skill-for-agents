---
title: "Depuração no Windows"
description: "Se experimentar falhas ou problemas no Electron que acredita que não são causados pelo seu aplicativo de JavaScript, mas devido ao próprio Electron, a depuração pode ser um pouco c"
topics:
  - "Nativo e desenvolvimento"
keywords:
  - "Depuração no Windows"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/development/debugging-on-windows"
---
...
**A debug build of Electron**: The easiest way is usually building it yourself, using the tools and prerequisites listed in the [build instructions for Windows](/pt/docs/latest/development/build-instructions-windows). While you can attach to and debug Electron as you can download it directly, you will find that it is heavily optimized, making debugging substantially more difficult: The debugger will not be able to show you the content of all variables and the execution path can seem strange because of inlining, tail calls, and other compiler optimizations.

- 

**Visual Studio com ferramentas C++**: As edições de comunidade livre de Visual Studio de 2013 e Visual Studio 2015, ambos trabalham. Once installed, [configure Visual Studio to use Electron's Symbol server](/pt/docs/latest/development/debugging-with-symbol-server). Permitirá que o Visual Studio obtenha uma melhor compreensão do que acontece dentro de Electron, tornando mais fácil para apresentar as variáveis num formato legível.
