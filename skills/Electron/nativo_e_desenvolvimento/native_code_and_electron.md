...
description: "One of Electron's most powerful features is the ability to combine web technologies with native code - both for compute-intensive logic as well as for the occasional native user in"
topics:
...
keywords:
  ...
  - "winget"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/native-code-and-electron"
---
...
2. Build it targeting your specific Electron version. `electron-forge` handles this step automatically for you - for more details, see [Native Node Modules](/pt/docs/latest/tutorial/using-native-node-modules).
