...
description: "Electron is built on two major upstream projects: Chromium and Node.js. Each of these projects has several of their own dependencies, too. We try our best to use these dependencies"
topics:
...
keywords:
  ...
  - "Profile"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/development/patches"
---
...
If `git-import-patches -3` encounters a merge conflict that it can't resolve automatically, it will pause and allow you to resolve the conflict manually. Once you have resolved the conflict, `git add` the resolved files and continue to apply the rest of the patches by running `git am --continue`.[Editar esta página](https://github.com/electron/electron/edit/main/docs/development/patches.md)[AnteriorCreating a New Electron Browser Module](/pt/docs/latest/development/creating-api)[AvançarEstrutura de Diretório do Código Fonte](/pt/docs/latest/development/source-code-directory-structure)
