...
description: "Documentação técnica e referência da API de Electron Fuses no Electron."
topics:
...
keywords:
  ...
  - "nodeOptions"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/fuses"
---
...
For more information on how to use ASAR integrity validation, please read the [Asar Integrity](/pt/docs/latest/tutorial/asar-integrity) documentation.
...
The `grantFileProtocolExtraPrivileges` fuse changes whether pages loaded from the `file://` protocol are given privileges beyond what they would receive in a traditional web browser. This behavior was core to Electron apps in original versions of Electron, but is no longer required as apps should be [serving local files from custom protocols](/pt/docs/latest/tutorial/security#18-avoid-usage-of-the-file-protocol-and-prefer-usage-of-custom-protocols) now instead.
...
[!NOTE] If you are using Electron Forge to distribute your application, you can flip fuses using [`@electron-forge/plugin-fuses`](https://www.electronforge.io/config/plugins/fuses), which comes pre-installed with all templates.
...
You can view the current schema [here](https://github.com/electron/electron/blob/v43.4.0/build/fuses/fuses.json5).[Editar esta página](https://github.com/electron/electron/edit/main/docs/tutorial/fuses.md)
