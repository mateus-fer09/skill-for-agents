---
title: "Assinando Código"
description: "Code signing is a security technology to certify that an app was created by you. You should sign your application so it does not trigger any operating system security warnings."
topics:
  - "Seguranca e otimizacao"
keywords:
  - "Assinando Código"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/code-signing"
---
...
See the [Mac App Store Guide](/pt/docs/latest/tutorial/mac-app-store-submission-guide).
...
See the [Windows Store Guide](/pt/docs/latest/tutorial/windows-store-guide).[Editar esta página](https://github.com/electron/electron/edit/main/docs/tutorial/code-signing.md)
