...
description: "ASAR integrity is a security feature that validates the contents of your app's [ASAR archives](/pt/docs/latest/tutorial/asar-archives) at runtime."
topics:
...
keywords:
  ...
  - "onlyLoadAppFromAsar"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/asar-integrity"
---

# ASAR Integrity

ASAR integrity is a security feature that validates the contents of your app's [ASAR archives](/pt/docs/latest/tutorial/asar-archives) at runtime.
...
ASAR integrity checking is currently disabled by default in Electron and can be enabled on build time by toggling the `EnableEmbeddedAsarIntegrityValidation` [Electron fuse](/pt/docs/latest/tutorial/fuses).
...
[!TIP] With Electron Forge, you can configure your app's fuses with [@electron-forge/plugin-fuses](https://www.electronforge.io/config/plugins/fuses) in your Forge configuration file.
...
[!NOTE] For an implementation example, see [`src/resedit.ts`](https://github.com/electron/packager/blob/main/src/resedit.ts) in the Electron Packager code.
