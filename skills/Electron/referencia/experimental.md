...
description: "Some of Electron's APIs are tagged with _Experimental_ in the documentation. This tag indicates that the API may not be considered stable and the API may be removed or modified mor"
topics:
  - "Referencia"
keywords:
  - "Experimental APIs"
  - "_Experimental_"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/experimental"
---
