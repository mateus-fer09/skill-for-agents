---
title: "O Processo Principal de Depuração"
description: "O DevTools em uma janela do navegador do Electron, só pode depurar JavaScript que é executado na janela (ex. uma web página). Para depurar JavaScript que é executado no processo pr"
topics:
  - "Testes e depuracao"
keywords:
  ...
  - "9229"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/debugging-main-process"
---
...
- [Debugging in VSCode](/pt/docs/latest/tutorial/debugging-vscode)
