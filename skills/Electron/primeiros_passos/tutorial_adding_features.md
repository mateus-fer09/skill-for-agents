...
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/tutorial-adding-features"
---
...
Esta é a **parte 4** do tutorial de Electron.
...
Electron's documentation has many tutorials to help you with more advanced topics and deeper operating system integrations. To get started, check out the [How-To Examples](/pt/docs/latest/tutorial/examples) doc.
...
For the rest of the tutorial, we will be shifting away from application code and giving you a look at how you can get your app from your developer machine into end users' hands.[Editar esta página](https://github.com/electron/electron/edit/main/docs/tutorial/tutorial-4-adding-features.md)[AnteriorUsando scripts de pré-carregamento](/pt/docs/latest/tutorial/tutorial-preload)[AvançarEmpacotando seu aplicativo](/pt/docs/latest/tutorial/tutorial-packaging)
