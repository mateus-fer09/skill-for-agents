---
title: "Publicando e atualizando"
description: "[!NOTE]"
topics:
  - "Primeiros passos"
keywords:
  ...
  - "devDependencies"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/tutorial/tutorial-publishing-updating"
---
...
Esta é a **parte 6** do tutorial de Electron.
...
If you're using an alternate repository host (e.g. GitLab or Bitbucket) or if you need to keep your code repository private, please refer to our [step-by-step guide](/pt/docs/latest/tutorial/updates) on hosting your own Electron update server.
...
From here, you have officially completed our tutorial to Electron. Feel free to explore the rest of our docs and happy developing! If you have questions, please stop by our community [Discord server](https://discord.gg/electronjs).[Editar esta página](https://github.com/electron/electron/edit/main/docs/tutorial/tutorial-6-publishing-updating.md)[AnteriorEmpacotando seu aplicativo](/pt/docs/latest/tutorial/tutorial-packaging)[AvançarModelos de Processo](/pt/docs/latest/tutorial/process-model)
...
- [Publishing a GitHub release](#publishing-a-github-release)
  ...
  - [Setting up the GitHub Publisher](#setting-up-the-github-publisher)

    - [Installing the module](#installing-the-module)
    - [Configuring the publisher in Forge](#configuring-the-publisher-in-forge)
    - [Setting up your authentication token](#setting-up-your-authentication-token)

  - [Running the publish command](#running-the-publish-command)

    - [Bonus: Publishing in GitHub Actions](#bonus-publishing-in-github-actions)

- [Instrumenting your updater code](#instrumenting-your-updater-code)
- [Sumário](#sumário)
Documentação
