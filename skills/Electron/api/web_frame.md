---
title: "webFrame"
description: "Documentação técnica e referência da API de webFrame no Electron."
topics:
  - "Api"
keywords:
  - "contextBridge"
  ...
  - "minimumLevel"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/web-frame"
---
...
[!NOTE] Visual zoom only applies to pinch-to-zoom behavior. Cmd+/-/0 zoom shortcuts are controlled by the 'zoomIn', 'zoomOut', and 'resetZoom' MenuItem roles in the application Menu. To disable shortcuts, manually [define the Menu](/pt/docs/latest/tutorial/menus) and omit zoom roles from the definition.
...
- `scripts` [WebSource[]](/pt/docs/latest/api/structures/web-source)
...
- `images` [MemoryUsageDetails](/pt/docs/latest/api/structures/memory-usage-details)

- `scripts` [MemoryUsageDetails](/pt/docs/latest/api/structures/memory-usage-details)

- `cssStyleSheets` [MemoryUsageDetails](/pt/docs/latest/api/structures/memory-usage-details)

- `xslStyleSheets` [MemoryUsageDetails](/pt/docs/latest/api/structures/memory-usage-details)

- `fonts` [MemoryUsageDetails](/pt/docs/latest/api/structures/memory-usage-details)

- `other` [MemoryUsageDetails](/pt/docs/latest/api/structures/memory-usage-details)
...
### `webFrame.findFrameByRoutingId(routingId)` *Descontinuado*
...
A `string` representing the unique frame token in the current renderer process. Distinct WebFrame instances that refer to the same underlying frame will have the same `frameToken`.[Editar esta página](https://github.com/electron/electron/edit/main/docs/api/web-frame.md)
