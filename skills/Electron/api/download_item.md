...
description: "## Class: DownloadItem"
topics:
  - "Api"
keywords:
  - "Class: DownloadItem"
  ...
  - "completed"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/download-item"
---
...
- `options` SaveDialogOptions - Set the save file dialog options. This object has the same properties as the `options` parameter of [`dialog.showSaveDialog()`](/pt/docs/latest/api/dialog).
