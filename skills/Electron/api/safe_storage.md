---
title: "safeStorage"
description: "Documentação técnica e referência da API de safeStorage no Electron."
topics:
  - "Api"
keywords:
  - "encryptStringAsync"
  ...
  - "basic_text"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/safe-storage"
---
...
O módulo `safeStorage` emite os seguintes eventos:
