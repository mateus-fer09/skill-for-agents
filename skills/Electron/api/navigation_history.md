...
description: "## Class: NavigationHistory"
topics:
  - "Api"
keywords:
  ...
  - "index"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/navigation-history"
---
...
Each [NavigationEntry](/pt/docs/latest/api/structures/navigation-entry) corresponds to a specific visited page.
...
Returns [NavigationEntry](/pt/docs/latest/api/structures/navigation-entry) - Navigation entry at the given index.
...
Returns [NavigationEntry[]](/pt/docs/latest/api/structures/navigation-entry) - WebContents complete history.
...
- `options` Object
  ...
  - `entries` [NavigationEntry[]](/pt/docs/latest/api/structures/navigation-entry) - Result of a prior `getAllEntries()` call
...
(see [`did-finish-load`](/pt/docs/latest/api/web-contents#event-did-finish-load)), and rejects
if the page fails to load (see
[`did-fail-load`](/pt/docs/latest/api/web-contents#event-did-fail-load)). A noop rejection handler is already attached, which avoids unhandled rejection errors.[Editar esta página](https://github.com/electron/electron/edit/main/docs/api/navigation-history.md)
