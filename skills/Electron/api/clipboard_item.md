---
title: "ClipboardItem"
description: "Documentação técnica e referência da API de ClipboardItem no Electron."
topics:
  - "Api"
keywords:
  - "ClipboardItem"
  ...
  - "Promise"
source_scope:
  - "https://electronjs.org/docs/latest/api/clipboard-item"
---
...
Construct a clipboard entry for [`clipboard.write()`](/docs/latest/api/clipboard#clipboardwritedata)
or inspect an entry returned from [`clipboard.read()`](/docs/latest/api/clipboard#clipboardread).
...
accepts a [ClipboardBookmark](/docs/latest/api/structures/clipboard-bookmark) object.
...
[`clipboard.write()`](/docs/latest/api/clipboard#clipboardwritedata). Each `Blob` or
...
[`clipboard.read()`](/docs/latest/api/clipboard#clipboardread) these are the MIME types
...
to a [ClipboardBookmark](/docs/latest/api/structures/clipboard-bookmark) object instead.
...
Returns `Promise<ClipboardBookmark>` - Resolves with a [ClipboardBookmark](/docs/latest/api/structures/clipboard-bookmark)
...
```
[Edit this page](https://github.com/electron/electron/edit/main/docs/api/clipboard-item.md)
