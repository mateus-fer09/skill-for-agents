---
title: "Switches de Linha de Comando Suportadas"
description: "Documentação técnica e referência da API de Switches de Linha de Comando Suportadas no Electron."
topics:
  - "Api"
keywords:
  ...
  - "trials"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/command-line-switches"
---
...
You can use [app.commandLine.appendSwitch](/pt/docs/latest/api/command-line#commandlineappendswitchswitch-value) to append them in your app's main script before the [ready](/pt/docs/latest/api/app#event-ready) event of the [app](/pt/docs/latest/api/app) module is emitted:
...
See the [Debugging the Main Process](/pt/docs/latest/tutorial/debugging-main-process) guide for more details.
