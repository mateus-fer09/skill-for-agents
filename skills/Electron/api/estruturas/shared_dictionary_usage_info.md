...
description: "- frameOrigin string - The origin of the frame where the request originates. It’s specific to the individual frame making the request and is defined by its scheme, host, and port. "
topics:
  - "Api"
  - "Estruturas"
keywords:
  ...
  - "totalSizeBytes"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/structures/shared-dictionary-usage-info"
---
