...
description: "- mode string (optional) - The proxy mode. Should be one of direct , auto_detect , pac_script , fixed_servers or system . Defaults to pac_script proxy mode if pacScript option is s"
topics:
  - "Api"
  - "Estruturas"
keywords:
  ...
  - "pacScript"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/structures/proxy-config"
---
...
be downloaded at [http://wpad/wpad.dat](http://wpad/wpad.dat).
...
"[https://x.\\*.y.com:99](https://x.%5C%5C*.y.com:99)"
...
Examples:
".google.com", ".com", "[http://.google.com](http://.google.com)"
