---
title: "Objeto NotificationAction"
description: "- type string - The type of action, can be button or selection . selection is only supported on Windows."
topics:
  - "Api"
  - "Estruturas"
keywords:
  ...
  - "items"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/structures/notification-action"
---
...
```
``````````[](https://github.com/electron/electron/edit/main/docs/api/structures/notification-action.md)[](/pt/docs/latest/api/structures/navigation-entry)[](/pt/docs/latest/api/structures/notification-response)
