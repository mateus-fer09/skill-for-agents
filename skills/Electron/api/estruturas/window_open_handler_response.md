...
description: "- action string - Can be allow or deny . Controls whether new window should be created."
topics:
  - "Api"
  - "Estruturas"
keywords:
  ...
  - "options"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/structures/window-open-handler-response"
---
