...
description: "- mode string (optional) - Controls which processes are profiled. Equivalent to --memlog in Chrome. Default is all ."
topics:
  - "Api"
  - "Estruturas"
keywords:
  ...
  - "10000000"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/structures/enable-heap-profiling-options"
---
