...
description: "- match string - The matching path pattern for the dictionary which was declared in 'use-as-dictionary' response header's match option."
topics:
  - "Api"
  - "Estruturas"
keywords:
  ...
  - "expires"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/structures/shared-dictionary-info"
---
