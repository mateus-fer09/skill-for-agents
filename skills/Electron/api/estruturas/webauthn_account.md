...
description: "- credentialId string - URL-safe base64-encoded (no padding) credential ID of the discoverable credential. Matches PublicKeyCredential.id returned by navigator.credentials.get() in"
topics:
  - "Api"
  - "Estruturas"
keywords:
  ...
  - "displayName"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/structures/webauthn-account"
---
