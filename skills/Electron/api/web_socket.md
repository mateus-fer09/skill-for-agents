...
description: "## Class: WebSocket extends EventTarget"
topics:
  - "Api"
keywords:
...
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/web-socket"
---
...
- `protocols` string | string[] | [WebSocketOptions](/pt/docs/latest/api/structures/web-socket-options) (optional) -
