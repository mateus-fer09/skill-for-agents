...
keywords:
  ...
  - "null"
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/web-request"
---
...
- `filter` [WebRequestFilter](/pt/docs/latest/api/structures/web-request-filter) (optional)
...
- `listener` Function | null
  ...
  - Objeto `details`
    ...
    - `uploadData` [UploadData[]](/pt/docs/latest/api/structures/upload-data)
...
- `listener` Function | null
  ...
  - Objeto `details`
    ...
    - `uploadData` [UploadData[]](/pt/docs/latest/api/structures/upload-data) (optional)
...
The `listener` will be called with `listener(details)` when an error occurs.[Editar esta página](https://github.com/electron/electron/edit/main/docs/api/web-request.md)
