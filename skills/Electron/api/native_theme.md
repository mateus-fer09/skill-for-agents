---
title: "nativeTheme"
description: "Documentação técnica e referência da API de nativeTheme no Electron."
topics:
  - "Api"
keywords:
  - "nativeTheme"
...
source_scope:
  - "https://www.electronjs.org/pt/docs/latest/api/native-theme"
---
...
A `boolean` that indicates whether the user prefers UI that differentiates items using something other than color alone (e.g. shapes or labels). This maps to [NSWorkspace.accessibilityDisplayShouldDifferentiateWithoutColor](https://developer.apple.com/documentation/appkit/nsworkspace/accessibilitydisplayshoulddifferentiatewithoutcolor).[Editar esta página](https://github.com/electron/electron/edit/main/docs/api/native-theme.md)
