...
> **Repositório:** `mateus-fer09/skill-for-agents`
> **Skill:** `skill_appmax`
> **Descrição:** Guia e referência técnica completa para integração com a plataforma e API da Appmax. Abrange conceitos fundamentais de arquitetura, fluxo de autenticação, instalação de aplicativos, endpoints da API v1, integração front-end com Appmax JS, gerenciamento de webhooks e exemplos práticos de código.
